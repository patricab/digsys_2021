...
HD_PWD='C:/Users/jacob/Elsys/21_H/TFE4141_Digsys/Digsys_project/digsys_2021/rsa_modmult/rsa_modmult/rsa_modmult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rsa_modmult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rsa_modmult.tcl
